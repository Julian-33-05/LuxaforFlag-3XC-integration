using LuxaforIntegration;
using System;
using System.Windows.Forms;
using MyPhonePlugins;
using System.Reflection;

namespace LuxaforIntegration
{
    [CRMPluginLoader]
    public class LuxaforPlugin
    {
        private static LuxaforPlugin _instance;
       ...
       // private Busylight.SDK busylight = null;
        ...
        //show busylight Mainform Disabled in final version
         ...
         //   frm.Show();
            _instance = new LuxaforPlugin(callHandler);
        ...
        public LuxaforPlugin(IMyPhoneCallHandler callHandler)
        {
